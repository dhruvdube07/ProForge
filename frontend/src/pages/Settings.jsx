        ...
        <div className="md:col-span-3 glass-panel premium-frame p-6 sm:p-8 rounded-[24px]">
          ...
          {activeTab === 'theme' && (
            <div className="space-y-6">
              <h2 className="text-base font-black text-themeText border-b border-themeBorder pb-2">Visual Theme Customization</h2>
              
              <p className="text-xxs text-themeTextSecondary leading-relaxed">
                Choose a professional visual theme profile. All styling parameters, color tones, and accents are gender-neutral.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 max-h-[350px] overflow-y-auto pr-1">
                {[
                  ...
                  <button
                    ...
                    className={`p-4.5 rounded-theme border text-left flex flex-col justify-between transition-all duration-300 hover-lift cursor-pointer ${
                      themeMode === th.key 
                        ? 'border-themePrimary bg-themePrimary/5 shadow-md' 
                        : 'border-themeBorder bg-themeCard hover:border-themePrimary/40'
                    }`}
                  >
                    <div className="flex justify-between items-start">
                      <span className="text-base">{th.emoji}</span>
                      {themeMode === th.key && <Check className="h-4 w-4 text-themePrimary" />}
                    </div>
                    <div className="mt-3">
                      <h4 className="text-xs font-black text-themeText">{th.name}</h4>
                      <p className="text-[10px] text-themeTextSecondary mt-1 leading-relaxed">
                        {th.desc}
                      </p>
                    </div>
                  </button>
              ...
              <div className="flex justify-end pt-4 border-t border-themeBorder">
                <button
                  onClick={async () => {
                    ...
                    try {
                      await updateUserProfile(firstName, lastName, themeMode);
                      setFeedbackMsg('Visual theme customization updated successfully!');
                    } catch (e) {
              ...
              <div className="space-y-4 pt-2">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder="gsk-••••••••••••••••••••••••"
                    className="w-full p-3 rounded-theme border border-themeBorder bg-themeBg focus:outline-none focus:border-themePrimary text-xs text-themeText font-mono"
                  />
                </div>
